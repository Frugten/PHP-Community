...
echo"<h1><b>Tilføj en tråd til forum gruppen</b><br>";
echo"$titel</h1>";
...
$_SESSION['test_tekst'] = $_SESSION['teksten'];
...
echo"".$_SESSION['test_overskrift']."<br>";
echo"".$_SESSION['test_tekst']."</b><br>";
echo"</td></tr></table><hr>";
}
$_SESSION['overskrift'] =stripslashes($_SESSION['overskrift']);
$_SESSION['teksten'] =stripslashes($_SESSION['teksten']);

echo"<table><tr><td>";
echo"</p>";
echo"<form name='postform' method='POST' ACTION='$side/forum/tiltraad.php?menu=$menu&gr=$gr'>";
echo"<b>Overskrift:</b> <input type='text' value='".$_SESSION['overskrift']."' name='overskrift' size='35' maxlength='255'><br>";
...
echo"<textarea class = 'fb_txtarea' name='message' id='message' rows='10' cols='60'>".$_SESSION['teksten']."</textarea><br>";
$_SESSION['teksten']="";
...
?>
Vil du modtage en mail når der svares på dennde tråd<br><br>
...
if ($antals >0)
{
echo"<b>smiley's</b><br>(Klik på den du vil indsætte)</p><br>";
