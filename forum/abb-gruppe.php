...
$gr = mysql_real_escape_string($_GET[gr]);
    ...
    mysql_query("INSERT INTO forum_abb (abbid, brugernavn, forumgr)
    values(0, '$bruger', '$gr')") or die(mysql_error());

     header("Location: $side/forum/visforum.php?menu=$menu&gr=$gr");
