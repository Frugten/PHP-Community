...
if(!empty ($gr))
{
echo"Udfyld formularen herunder. Det kan være en fordel, at skrive artiklen i et tekstbehandlings program inden du skriver den her. ";
echo"På den måde undgår du at miste noget, hvis der sker en fejl her på siden. Din artikel vil ikke blive vist for andre brugere, før ";
echo"du aktivere den<br><br>";
$resultat = mysql_query("SELECT titel FROM artikelgr WHERE grID = '$gr'");//Spørger efter ID
$show = mysql_fetch_array($resultat);
$titel = $show[titel];
$titel =stripslashes($titel);

echo"Du har valgt at tilføje en artikel i kategorien:<br><b>$titel</b> ";
echo"<a href='opret-artikel.php?menu=$menu'>Ændre kategori</a>";
if($_SESSION['ikke'] == 1)
{
echo"<div class='farvet'>Felter med * skal udfyldes</div>";
$_SESSION['ikke'] = 0;
}
echo "<table><tr><td>";
echo"<table><tr>";
echo"<form name='postform' method='POST' ACTION='tilfoj.php?menu=$menu&gr=$gr'>";
echo"<td>*Titel:</td><td><input type='text' name='titel' value='".$_SESSION['titel']."' size='35' maxlength='255'></td></tr>";
echo"<tr><td>*Beskrivelse:</td><td><input type='text'  value='".$_SESSION['beskrivelse']."' name='beskrivelse' size='50' maxlength='255'></td></tr>";
...
echo"".$_SESSION['artikel']."</textarea></td></tr>";
echo"<tr><td>Pris:</td>";
echo"<td>";
...
echo"</td></tr>";
echo"<tr><td></td><td><input class='inputknap' type='submit' value='Send'>";
echo"<input class='inputknap' type='reset' value='Nulstil'></td></tr>";
echo"</table>";
echo"</form>";
echo "</td><td>";
...
{
echo"<h2>Vælg den kategori du vil skrive en artikel i</h2>";
...
echo"<tr><td class='kant'><b><a href='opret-artikel.php?menu=$menu&gr=$id'>$titel</a></b>";
echo"<br>$beskrivelse</td><td class='kant'>$antallet</td></tr>";
}
}
