...
$resultat = mysql_query("SELECT laest FROM mail_ind WHERE indid= '$id' AND til = '$bruger'");//Spørger efter ID
$number = mysql_num_rows($resultat);//Tæller antaller af resultater
if($number == 1)
{
mysql_query("DELETE FROM mail_ind WHERE indid='$id'") or die(mysql_error());
